            ...
            <div class="flex justify-between items-start mb-4">
                <div class="flex flex-wrap gap-1.5">
                    <?php if (isset($prompt['category_slug'])): ?>
                        <a href="prompts/<?php echo esc($prompt['category_slug']); ?>" class="inline-flex items-center px-2.5 py-1 rounded-lg text-[10px] font-bold bg-primary-50 text-primary-700 uppercase tracking-widest border border-primary-100/50 hover:bg-primary-600 hover:text-white hover:border-primary-600 transition-all duration-300">
            ...
            <div class="mt-auto pt-4 border-t border-slate-50 flex items-center justify-between">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <?php if (is_logged_in() && $prompt['user_id'] == get_current_user_id()): ?>
                        <a href="prompt_edit.php?id=<?php echo $prompt['id']; ?>" class="p-2 text-slate-400 hover:text-amber-600 hover:bg-amber-50 rounded-xl transition-all" title="Edit">
                    ...
                    <?php endif; ?>
                    <a href="prompt.php?id=<?php echo $prompt['id'] . '-' . $prompt['slug']; ?>" class="p-2 text-slate-400 hover:text-primary-600 hover:bg-primary-50 rounded-xl transition-all" title="View Full Prompt">
