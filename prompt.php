...
<div class="max-w-5xl mx-auto">
    ...
    <!-- Share Toolbar -->
    <div class="flex items-center gap-4 mb-8 p-4 bg-white rounded-2xl border border-slate-100 shadow-sm">
        <span class="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-2">Share Prompt</span>
        <div class="h-4 w-px bg-slate-100 mx-2"></div>
        <div class="flex items-center gap-2">
            <a href="https://twitter.com/intent/tweet?text=<?php echo urlencode("Check out this AI prompt: " . $prompt['title']); ?>&url=<?php echo urlencode($canonical_url); ?>" 
                target="_blank" class="p-2 text-slate-400 hover:text-[#1DA1F2] hover:bg-[#1DA1F2]/5 rounded-xl transition-all" title="Share on Twitter">
            ...
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo urlencode($canonical_url); ?>" 
                target="_blank" class="p-2 text-slate-400 hover:text-[#0A66C2] hover:bg-[#0A66C2]/5 rounded-xl transition-all" title="Share on LinkedIn">
            ...
            <button onclick="copyToClipboard('<?php echo $canonical_url; ?>', this)" 
                class="p-2 text-slate-400 hover:text-primary-600 hover:bg-primary-50 rounded-xl transition-all" title="Copy Direct Link">
